...
const Selector: FunctionComponent<SelectorProps> = ({
    ...
    //console.log("productName=", productName); // Value is apparently fixed to static text "Product"
    //console.log("product", product); // Correct value for product name will be used
